...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Mi Perfil"), backgroundColor: Colors.orange, foregroundColor: Colors.white),
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (_carnetController.text.isEmpty) _carnetController.text = data?['carnet'] ?? '';
          ...
          return SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  const Text("Datos Académicos y de Contacto", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
